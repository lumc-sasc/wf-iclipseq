...
Install as needed with `install.packages("namelib")`, where `namelib` is the name of the library.
...
```{r}
general_path = "/exports/sascstudent/amhsilie/wf-iclipseq/all_iclip/results_nocontrol/results/downstream_analysis/homer/" # <- do not forget the last /
save_path = "/exports/sascstudent/amhsilie/iclip_downstream/final_annotation/homer/nocontrol/" 
...
test <- m_couples[,grepl("pureclip_wt_*", colnames(m_couples))]
