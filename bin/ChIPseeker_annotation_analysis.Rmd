...
The other plots are made using mostly ggplots2.
...
citation("UpSetR")
citation("ggupset")
citation("biomaRt") # to generate gene lengths
citation("ggplot2") # for plotting
citation("RColorBrewer") # for generation of palettes
citation("data.table") # for data storage and manipulation
citation("Rsubread") # ???
citation("randomcoloR") # for generation of palettes
citation("tidyverse") # we use many modules from this package
citation("scales") # for plotting
citation("ggrepel") # for plotting
```
...
Adjusting the dataframe so it fits the analysis also used for HOMER (so I can reuse the code).
